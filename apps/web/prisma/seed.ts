...
async function main() {
    ...
    for (const l of LENDERS) {
        ...
        await prisma.dealActivity.create({ data: { actor: 'system', actorName: 'Seeder', entity: 'Lender', entityId: lender.id, action: 'CREATE' } });
    }
    ...
    for (let i = 0; i < 24; i++) {
        ...
        await prisma.dealActivity.create({ data: { actor: 'system', actorName: 'Seeder', entity: 'Borrower', entityId: borrower.id, action: 'CREATE' } });
    }
    ...
    for (let i = 0; i < 18; i++) {
        ...
        await prisma.dealActivity.create({ data: { actor: 'system', actorName: 'Seeder', entityId: deal.id, entity: 'Deal', action: 'CREATE' } });

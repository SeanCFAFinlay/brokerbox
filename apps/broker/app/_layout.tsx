  ...
  if (!isUnlocked) {
    return (
      <View style={[styles.container, { justifyContent: 'center', padding: 24 }]}>
        <Text style={styles.title}>Broker Portal Gate</Text>
        <Text style={styles.subtitle}>Enter development password to access Internal CRM</Text>
        ...
        <TouchableOpacity style={styles.button} onPress={handleLogin}>
          <Text style={styles.buttonText}>Unlock BrokerApp</Text>
        </TouchableOpacity>
      </View>
    );
  }

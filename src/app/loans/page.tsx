            ...
            <div className={s.kpiRow} style={{ marginBottom: 32 }}>
                ...
                <div className={s.kpiCard}>
                    ...
                    <div className={s.kpiValue}>
                        {activeLoans.length > 0 ? (activeLoans.reduce((sum: number, l: any) => sum + (l.interestRate || 0), 0) / activeLoans.length).toFixed(2) : '0.00'}%
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            {loans.map((l: any) => (
                                <tr key={l.id}>
                                    ...
                                    <td>{l.maturityDate ? new Date(l.maturityDate).toLocaleDateString() : '—'}</td>
                                    <td>
